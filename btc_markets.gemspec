...
Gem::Specification.new do |spec|
  spec.name          = "btc_markets"
  spec.version       = BTCMarkets::VERSION
  spec.authors       = ["Chun-wei Kuo"]
  spec.email         = ["Dendoh@gmail.com"]

  spec.summary       = %q{Unofficial BTC Markets API client}
  spec.description   = %q{Unofficial BTC Markets API client}
  spec.homepage      = "https://github.com/Domon/btc_markets"
